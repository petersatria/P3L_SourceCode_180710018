<template>
    <v-container>
        <v-card class="mt-10 pa-10">
            <v-card-title
            class="font-weight-black d-flex justify-center mb-5 text">Laporan Pendapatan Per Tahun</v-card-title>
            <v-card-text>
...
export default {
    ...
    methods : {       
        submit(){
            window.open(this.$apiUrl+'laporan/pendapatanByYear?tahun='+this.tgl);
        }
    },
}
</script>