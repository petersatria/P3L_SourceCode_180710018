...
export default {
    ...
    data: () => ({
        drawer : false,
        items: [
            { title: 'Promo', path : '/kepalaKlinik/promo'},
            { title: 'Jadwal', path : '/kepalaKlinik/jadwal'},
            { title: 'Laporan Jumlah Customer', path : '/kepalaKlinik/laporan/customer'},
            { title: 'Laporan Pendapatan', path : '/kepalaKlinik/laporan/pendapatan'},
            { title: 'Laporan Produk Teraris', path : '/kepalaKlinik/laporan/produk'},
            { title: 'Laporan Perawatan Teraris', path : '/kepalaKlinik/laporan/perawatan'},
            ],
    }),
    methods : {
      logout(){
