...
class LogModel extends CI_Model
{
    ...
    public function layananGet(){
        return $this->db->query("SELECT * FROM(SELECT concat(jl.nama,' ', uh.nama ) as nama ,'dibuat' as keterangan,l.created_at AS Time, pg.nama AS pegawai from layanan l join jenis_layanan jl on l.id_layanan = jl.id join ukuran_hewan uh on uh.id = l.id_ukuran_hewan JOIN pegawai pg on l.created_by = pg.id UNION ALL SELECT concat(jl.nama,' ', uh.nama ) as nama, IF(l.isDelete = 0, 'diubah', 'dihapus') as keterangan, l.updated_at AS Time, pg.nama as pegawai FROM layanan l join jenis_layanan jl on l.id_layanan = jl.id join ukuran_hewan uh on uh.id = l.id_ukuran_hewan JOIN pegawai pg ON l.updated_by = pg.id) dum order by time desc")->result();
    }

    public function layananSearchByPegawai($pegawai){
        return $this->db->query("SELECT * FROM(SELECT concat(jl.nama,' ', uh.nama ) as nama ,'dibuat' as keterangan,l.created_at AS Time, pg.nama AS pegawai from layanan l join jenis_layanan jl on l.id_layanan = jl.id join ukuran_hewan uh on uh.id = l.id_ukuran_hewan JOIN pegawai pg on l.created_by = pg.id UNION ALL SELECT concat(jl.nama,' ', uh.nama ) as nama, IF(l.isDelete = 0, 'diubah', 'dihapus') as keterangan, l.updated_at AS Time, pg.nama as pegawai FROM layanan l join jenis_layanan jl on l.id_layanan = jl.id join ukuran_hewan uh on uh.id = l.id_ukuran_hewan JOIN pegawai pg ON l.updated_by = pg.id) dum where pegawai like '$pegawai' order by time desc ")->result();
    }

    public function layananSearchByName($nama){
        return $this->db->query("SELECT * FROM(SELECT concat(jl.nama,' ', uh.nama ) as nama ,'dibuat' as keterangan,l.created_at AS Time, pg.nama AS pegawai from layanan l join jenis_layanan jl on l.id_layanan = jl.id join ukuran_hewan uh on uh.id = l.id_ukuran_hewan JOIN pegawai pg on l.created_by = pg.id UNION ALL SELECT concat(jl.nama,' ', uh.nama ) as nama, IF(l.isDelete = 0, 'diubah', 'dihapus') as keterangan, l.updated_at AS Time, pg.nama as pegawai FROM layanan l join jenis_layanan jl on l.id_layanan = jl.id join ukuran_hewan uh on uh.id = l.id_ukuran_hewan JOIN pegawai pg ON l.updated_by = pg.id) dum where nama like '$nama' order by time desc ")->result();
    }

    public function layananSearchByTime($time){
        return $this->db->query("SELECT * FROM(SELECT concat(jl.nama,' ', uh.nama ) as nama ,'dibuat' as keterangan,l.created_at AS Time, pg.nama AS pegawai from layanan l join jenis_layanan jl on l.id_layanan = jl.id join ukuran_hewan uh on uh.id = l.id_ukuran_hewan JOIN pegawai pg on l.created_by = pg.id UNION ALL SELECT concat(jl.nama,' ', uh.nama ) as nama, IF(l.isDelete = 0, 'diubah', 'dihapus') as keterangan, l.updated_at AS Time, pg.nama as pegawai FROM layanan l join jenis_layanan jl on l.id_layanan = jl.id join ukuran_hewan uh on uh.id = l.id_ukuran_hewan JOIN pegawai pg ON l.updated_by = pg.id) dum where time like '$time' order by time desc ")->result();
    }
