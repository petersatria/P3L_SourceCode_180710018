...
class JenisLayanan extends REST_Controller
{
	...
	{
        if($id==null){
            $response = $this->JenisLayananModel->get();
			return $this->returnData($response, false);
        }else{
			$response = $this->JenisLayananModel->search($id);
			return $this->returnData($response,false);
		}
	}

	public function byString_get($nama = null){
		$response = $this->JenisLayananModel->searchByString($nama);
		return $this->returnData($response, false);
	}
	...
	public function index_post($id = null)
	{
		...
		$rule = $this->JenisLayananModel->rules();
		if($id != null){
			array_push(
				$rule,
				[
